...
import polarity.shared.netdata.ChunkData;
...
public class GameWorld {
    ...
    // [Server-Side] Updates QuadTree bounds to match the ever-expanding polarity.shared.world
    ...
    public Projectile addProjectile(ProjectileEvent attack) {
        ...
        p.create(0.25f, attack.getStart(), attack.getTarget());    // Creates the projectile polarity.shared.entity
        entities.add(p);    // Adds to the list of entities in the polarity.shared.world
        return p;
    }
    ...
    public PlayerEntity addPlayerEntity(Player player, ColorRGBA color) {
        ...
        entities.add(e);    // Adds to the list of entities in the polarity.shared.world
        return e;
    }
    ...
    // [Mutual] Main polarity.shared.world update loop
    public void update(float tpf) {
        // Updates all entities currently in the polarity.shared.world
        // Might need to be changed, sounds super inefficient...
        quadTree.clear();
        int i = 0;
        Entity t;   // Temp polarity.shared.entity
    ...
    // [Server-Side] Generates the initial chunks for the starting zone of the polarity.shared.world

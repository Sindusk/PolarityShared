...
public class Player extends LivingCharacter{
    ...
    public void attack(Vector2f cursorLoc){
        ...
        Vector3f worldTarget = Util.getWorldLoc(cursorLoc, Sys.getCamera());    // Analyzes where in polarity.shared.world space the player clicked.
    ...
    public void updateLocal(float tpf, Vector2f cursorLocWorld, Vector2f cursorLoc){
        ...
        // Apply movement & rotation to polarity.shared.entity

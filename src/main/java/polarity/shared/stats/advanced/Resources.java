package polarity.shared.stats.advanced;

import java.util.ArrayList;
import polarity.shared.spellforge.nodes.GeneratorData;
import polarity.shared.stats.Energy;
import polarity.shared.stats.Mana;
import polarity.shared.stats.Resource;

/**
 * Contains the actual values of the polarity.shared.character's resources.
 * @author Sindusk
 */

...
import polarity.shared.netdata.destroyers.DestroyProjectileData;
...
public class Projectile extends Entity{
     ...
     * <p>
     * Note: This does not actually create the Projectile geometry, nor identify it in the polarity.shared.world space.

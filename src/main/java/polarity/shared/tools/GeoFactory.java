...
import polarity.shared.tools.SinText.Alignment;
...
public class GeoFactory {
     ...
     * <p>
     * Mainly used for text placed in the polarity.shared.world. GUI text does not need this.
     */
     ...
     * @param size Size of the geometry. Keep in mind that the resulting size is twice the polarity.shared.input value.
     * The Geometry is generated from the center and extends to (polarity.shared.input value) in each direction along that axis.
